...
- [x] **P2** `@unchecked Sendable` on `MatchMetadataBox` - Safe by design. Mutation only occurs during initialization (synchronous callback), object is immutable afterward. Annotation is correct.
